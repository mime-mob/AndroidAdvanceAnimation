package com.mime.common_anim_util.anim_path_view.res;
...
public class StoreHousePath {
    ...
    public static final float VIEW_PORT_WIDTH = 47;

    public static final float VIEW_PORT_HEIGHT = 72;
    ...
    /**
     * 根据字符串创建用于构建path的数组，可设置缩放比例、字符间距
     */
