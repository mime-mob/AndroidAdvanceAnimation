package com.mime.common_anim_util.util;
...
public class SvgPathParser {
    ...
    public static final int TOKEN_ABSOLUTE_COMMAND = 1;
    public static final int TOKEN_RELATIVE_COMMAND = 2;
    public static final int TOKEN_VALUE = 3;
    public static final int TOKEN_EOF = 4;
    ...
    public SvgPathParser(int token) {
